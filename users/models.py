...
class CustomUserManager(BaseUserManager):
    def _create_user(
        self, first_name, last_name, email, password, **extra
    ) -> AbstractUser:
        if not email:
        ...
        user: AbstractUser = self.model(
            email=email, first_name=first_name, last_name=last_name, **extra
        )
    ...
    def create_user(
        self, first_name=None, last_name=None, email=None, password=None, **extra
    ) -> AbstractUser:
    ...
    def create_superuser(
        self, first_name="admin", last_name="", email=None, password=None, **extra
    ) -> AbstractUser:
